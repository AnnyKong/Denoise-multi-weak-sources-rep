...
def lf():
    #### 0: international
    r1 = ["atomic", "captives", "baghdad", "israeli", "iraqis", "iranian", "afghanistan", "wounding", "terrorism",
          "soldiers",
          "palestinians", "palestinian", "policemen", "iraqi", "terrorist", 'north korea', 'korea',
          'israel', 'u.n.', 'egypt', 'iran', 'iraq', 'nato', 'armed', 'peace']
    r2 = [' war ', 'prime minister', 'president', 'commander', 'minister', 'annan', "military", "militant", "kill",
          'operator']
    #### 1: sports
    r3 = ["goals", "bledsoe", "coaches", "touchdowns", "kansas", "rankings", "no.",
          "champ", "cricketers", "hockey", "champions", "quarterback", 'club', 'team', 'baseball', 'basketball',
          'soccer', 'football', 'boxing', 'swimming',
          'world cup', 'nba', "olympics", "final", "finals", 'fifa', 'racist', 'racism']
    r4 = ['athlete', 'striker', 'defender', 'goalkeeper', 'midfielder', 'shooting guard', 'power forward',
          'point guard', 'pitcher', 'catcher', 'first base', 'second base', 'third base', 'shortstop', 'fielder']
    # r3 = ["tech", "digital", "internet", "mobile"]
    r5 = ['lakers', 'chelsea', 'piston', 'cavaliers', 'rockets', 'clippers', 'ronaldo',
          'celtics', 'hawks', '76ers', 'raptors', 'pacers', 'suns', 'warriors', 'blazers', 'knicks', 'timberwolves',
          'hornets', 'wizards', 'nuggets', 'mavericks', 'grizzlies', 'spurs',
          'cowboys', 'redskins', 'falcons', 'panthers', 'eagles', 'saints', 'buccaneers', '49ers', 'cardinals',
          'texans', 'seahawks', 'vikings', 'patriots', 'colts', 'jaguars', 'raiders', 'chargers', 'bengals', 'steelers',
          'browns',
          'braves', 'marlins', 'mets', 'phillies', 'cubs', 'brewers', 'cardinals', 'diamondbacks', 'rockies', 'dodgers',
          'padres', 'orioles', 'sox', 'yankees', 'jays', 'sox', 'indians', 'tigers', 'royals', 'twins', 'astros',
          'angels', 'athletics', 'mariners', 'rangers',
          'arsenal', 'burnley', 'newcastle', 'leicester', 'manchester united', 'everton', 'southampton', 'hotspur',
          'tottenham', 'fulham', 'watford', 'sheffield', 'crystal palace', 'derby', 'charlton', 'aston villa',
          'blackburn', 'west ham', 'birmingham city', 'middlesbrough',
          'real madrid', 'barcelona', 'villarreal', 'valencia', 'betis', 'espanyol', 'levante', 'sevilla', 'juventus',
          'inter milan', 'ac milan', 'as roma', 'benfica', 'porto', 'getafe', 'bayern', 'schalke', 'bremen', 'lyon',
          'paris saint', 'monaco', 'dynamo']
    #### 3:tech
    ...
    r6 = ["technology", "engineering", "science", "research", "cpu", "windows", "unix", "system", 'computing',
          'compute']  # , "wireless","chip", "pc", ]
    ...
    r8 = ["stock", "account", "financ", "goods", "retail", 'economy', 'chairman', 'bank', 'deposit', 'economic',
          'dow jones', 'index', '$', 'percent', 'interest rate', 'growth', 'profit', 'tax', 'loan', 'credit', 'invest']
...
df = pd.read_csv("fbnews_labeled.csv")  # originally named 'AGnews_train.csv', with a size of 120000

df_train1 = df[['tag', 'text']]
df_train = df[['text']]
Y_train = df.tag.values

df_dev = df[['tag', 'text']].sample(50, random_state=3)  # from the training
...
# ----------- Majority Voting ------------
maj_voter = MajorityLabelVoter(cardinality=4)
major_label = maj_voter.predict(L_train, tie_break_policy='random')


# ------------- save ----------------
df_train1["major_label"] = major_label
...
df_train1.to_csv("fbnews_LF.csv")